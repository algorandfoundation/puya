from puyapy import AppStorage, Bytes, Contract, UInt64


class GlobalStorageContract(Contract):
    def __init__(self) -> None:
        self.global_int_full = AppStorage(UInt64(55))
        self.global_int_simplified = UInt64(33)
        self.global_int_no_default = AppStorage(UInt64)

        self.global_bytes_full = AppStorage(Bytes(b"Hello"))
        self.global_bytes_simplified = Bytes(b"Hello")
        self.global_bytes_no_default = AppStorage(Bytes)
