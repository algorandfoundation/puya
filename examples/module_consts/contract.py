...
import examples.module_consts.constants as consts
from examples.module_consts import constants, constants4
from examples.module_consts.constants import BANNED, EXT_ONE, EXT_ZERO
from examples.module_consts.constants2 import *  # noqa: F403
from examples.module_consts.constants3 import *  # noqa: F403

T = True and (1 == 1)

_T = typing.TypeVar("_T")
TruthyType = bool | typing.Literal[0] | typing.Literal[1]
