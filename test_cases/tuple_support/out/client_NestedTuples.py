...
class NestedTuples(algopy.arc4.ARC4Client, typing.Protocol):
    ...
    def nested_named_tuple_params(
        self,
        args: Parent,
    ) -> algopy.arc4.Tuple[algopy.arc4.UIntN[typing.Literal[64]], algopy.arc4.UIntN[typing.Literal[64]], algopy.arc4.Tuple[algopy.arc4.UIntN[typing.Literal[64]], algopy.arc4.DynamicBytes, algopy.arc4.String]]: ...
