...
from algopy import arc4, UInt64, Account, log, BoxMap, subroutine, op, Asset, Global, gtxn, itxn, Txn

class ListingKey(typing.NamedTuple): # compare this, (Struct), (Struct, frozen=True), (MutableStruct),
    owner: Account
    asset: UInt64
    nonce: UInt64

class ListingValue(typing.NamedTuple):
    deposited: UInt64
    unitaryPrice: UInt64
    bidder: Account
    bid: UInt64
