...
class ArrayGenericTypeBuilder(GenericTypeBuilder):
    ...
    def call(
        ...
        # TODO: auto parameterize from type
...
class ArrayExpressionBuilder(InstanceExpressionBuilder[pytypes.ArrayType]):
    ...
    def contains(self, item: InstanceBuilder, location: SourceLocation) -> InstanceBuilder:
        return _not_supported(pytypes.BoolType, location)
...
def _not_supported(typ: pytypes.PyType, location: SourceLocation) -> InstanceBuilder:
    logger.error("TODO: support this", location=location)
