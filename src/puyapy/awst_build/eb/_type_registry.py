...
PYTYPE_TO_TYPE_BUILDER: dict[pytypes.PyType, CallableBuilderFromSourceFactory] = {
    ...
    pytypes.GenericGlobalMapType: storage.GlobalMapGenericTypeExpressionBuilder,
    pytypes.GenericLocalMapType: storage.LocalMapGenericTypeExpressionBuilder,
    ...
    pytypes.GenericImmutableFixedArrayType: native.ImmutableFixedArrayGenericTypeBuilder,
...
PYTYPE_GENERIC_TO_TYPE_BUILDER: dict[
    ...
    pytypes.GenericGlobalMapType: storage.GlobalMapTypeBuilder,
    pytypes.GenericLocalMapType: storage.LocalMapTypeBuilder,
    ...
    pytypes.GenericImmutableFixedArrayType: native.ImmutableFixedArrayTypeBuilder,
...
PYTYPE_GENERIC_TO_BUILDER: dict[
    ...
    pytypes.GenericImmutableFixedArrayType: native.ImmutableFixedArrayExpressionBuilder,
    ...
    pytypes.GenericGlobalMapType: storage.GlobalMapProxyExpressionBuilder,
    pytypes.GenericLocalMapType: storage.LocalMapProxyExpressionBuilder,
