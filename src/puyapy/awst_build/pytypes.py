...
def _make_parameterise_arc4_static_array(*, immutable: bool) -> _Parameterise[ArrayType]:
    def _parameterise_arc4_static_array(
        ...
        if immutable:
            ...
            bases = (GenericImmutableFixedArrayType.parameterise(args, source_location),)
