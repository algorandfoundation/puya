...
class _ABIBytesBacked(typing.Protocol):
    ...
    @classmethod
    def from_bytes(cls, value: algopy.Bytes) -> typing.Self:
...
class String(ABIEncoded[algopy.Bytes]):
    def __init__(self, value: typing.LiteralString) -> None: ...

_TBitSize = typing.TypeVar("_TBitSize", bound=int)

class UIntN(typing.Generic[_TBitSize], ABIEncoded[algopy.UInt64]):
    def __init__(self, value: int | algopy.UInt64 | algopy.BigUInt) -> None: ...

class BigUIntN(typing.Generic[_TBitSize], ABIEncoded[algopy.BigUInt]):
    def __init__(self, value: int | algopy.UInt64 | algopy.BigUInt) -> None: ...

_TDecimalPlaces = typing.TypeVar("_TDecimalPlaces", bound=int)

class UFixedNxM(typing.Generic[_TBitSize, _TDecimalPlaces], ABIEncoded[algopy.UInt64]):
...
class BigUFixedNxM(typing.Generic[_TBitSize, _TDecimalPlaces], ABIEncoded[algopy.BigUInt]):
    def __init__(self, value: typing.LiteralString):
        """
        Construct an instance of UFixedNxM where value (v) is determined from the original
        decimal value (d) by the formula v = round(d * (10^M))
