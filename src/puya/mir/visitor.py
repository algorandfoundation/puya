...
class MIRVisitor(abc.ABC, typing.Generic[_T]):
    ...
    @abc.abstractmethod
    def visit_abstract_store(self, store: models.AbstractStore) -> _T: ...
    ...
    @abc.abstractmethod
    def visit_program_exit(self, op: models.ProgramExit) -> _T: ...

    @abc.abstractmethod
    def visit_err(self, op: models.Err) -> _T: ...

    @abc.abstractmethod
    def visit_goto(self, op: models.Goto) -> _T: ...

    @abc.abstractmethod
    def visit_conditional_branch(self, op: models.ConditionalBranch) -> _T: ...

    @abc.abstractmethod
    def visit_switch(self, op: models.Switch) -> _T: ...

    @abc.abstractmethod
    def visit_match(self, op: models.Match) -> _T: ...
