...
CREATE_PAYMENT_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.payment_txn"
CREATE_ASSET_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.create_asset_txn"
CONFIG_ASSET_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.config_asset_txn"
FREEZE_ASSET_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.freeze_asset_txn"
TRANSFER_ASSET_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.transfer_asset_txn"
CREATE_APPLICATION_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.create_application_txn"
UPDATE_APPLICATION_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.update_application_txn"
CALL_APPLICATION_TRANSACTION = f"{PUYAPY_PREFIX}_transactions.call_application_txn"
