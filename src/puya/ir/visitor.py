...
class ValueProviderVisitor[T](ABC):
    @abstractmethod
    ...
    @abstractmethod
    def visit_replace_value(self, write: puya.ir.models.ReplaceValue) -> T: ...
    ...
    @abstractmethod
    def visit_bytes_encode(self, encode: puya.ir.models.BytesEncode) -> T: ...

    @abstractmethod
    def visit_decode_bytes(self, decode: puya.ir.models.DecodeBytes) -> T: ...


class IRVisitor[T](ValueProviderVisitor[T]):
    @abstractmethod
    ...
    @abstractmethod
    def visit_assert(self, assert_: puya.ir.models.Assert) -> T: ...
...
class IRTraverser(IRVisitor[None]):
    ...
    def visit_assert(self, assert_: puya.ir.models.Assert) -> None:
    ...
    def visit_array_concat(self, concat: puya.ir.models.ArrayConcat) -> None:
        concat.base.accept(self)
        concat.items.accept(self)
        concat.num_items.accept(self)
    ...
    def visit_replace_value(self, write: puya.ir.models.ReplaceValue) -> None:
    ...
    def visit_bytes_encode(self, encode: puya.ir.models.BytesEncode) -> None:
        for v in encode.values:
            v.accept(self)

    def visit_decode_bytes(self, decode: puya.ir.models.DecodeBytes) -> None:
...
class NoOpIRVisitor[T](IRVisitor[T | None]):
    ...
    def visit_assert(self, assert_: puya.ir.models.Assert) -> T | None:
        return None

    def visit_array_length(self, read: puya.ir.models.ArrayLength) -> T | None:
        return None

    def visit_array_pop(self, pop: puya.ir.models.ArrayPop) -> T | None:
        return None
    ...
    def visit_replace_value(self, write: puya.ir.models.ReplaceValue) -> T | None:
        return None
    ...
    def visit_bytes_encode(self, encode: puya.ir.models.BytesEncode) -> T | None:
        return None

    def visit_decode_bytes(self, decode: puya.ir.models.DecodeBytes) -> T | None:
        return None
