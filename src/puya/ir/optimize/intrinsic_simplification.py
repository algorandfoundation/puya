                ...
                if (
                    ...
                    match byte_arg_defn.source:
                        case models.Intrinsic(
                            ...
                            # else we can't safely optimize this
...
def _try_simplify_bool_binary_op_one_const(
    op: AVMOp,
    a: models.Value,
    b: models.Value,
    a_const: int | None,
    b_const: int | None,
) -> int | models.Value | None:
    match op:
        case AVMOp.gte:
            # a >= 0 <-> 1
            if b_const == 0:
