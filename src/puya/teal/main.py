...
def mir_to_teal(
    ...
    if program_mir.autosalt is not None:
        autosalt = program_mir.autosalt
    else:
        # salt lsigs by default on any version
        # leave contracts unsalted by default
        autosalt = program_mir.kind is ProgramKind.logic_signature
