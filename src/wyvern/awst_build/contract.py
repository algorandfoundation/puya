...
from wyvern.ir.arc4_util import wtype_to_arc4
from wyvern.metadata import ARC4DefaultArgument, ARC4MethodConfig, ARC32StructDef
        ...
        case mypy.nodes.CallExpr(
            ...
            return ARC4MethodConfig(
                ...
                allowed_completion_types=[
                    wyvern.metadata.OnCompletionAction[a] for a in allow_actions
                ],
...
class _DecoratorArgEvaluator(mypy.visitor.NodeVisitor[typing.Any]):
    def __getattribute__(self, name: str) -> object:
        ...
        if name.startswith("visit_") and not attr.__module__.startswith("wyvern."):
