...
from wyvern.awst_build.eb import (
    arc4,
    array,
    biguint,
    bool as bool_,
...
from wyvern.awst_build.eb.reference_types import account, application, asset
...
def get_type_builder(
    ...
    try:
        ...
        raise CodeError(f"Unhandled algopy name: {python_type}", source_location) from ex
    else:
