...
class ItxnOverrides(TypedDict, total=False):
    sender: Account
    fee: UInt64
    first_valid: UInt64
    last_valid: UInt64
...
class Itxn:
    def __init__(self, **overrides: ItxnOverrides):
        self._overrides = overrides

    def _get_property(self, _name: str, default: T) -> T:
        return cast(T, self._overrides.get(_name, MagicMock(spec=default)))
