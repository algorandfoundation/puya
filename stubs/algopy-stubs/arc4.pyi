...
@typing.overload
def emit(event: Struct | algopy.Struct, /) -> None: ...
@typing.overload
...
def decode(
    ...
    :param typ: The target type to decode into.
    :param value: The ARC-4 encoded bytes to decode.
    :param validate: If True (default), validates the encoding of `value` bytes.
    """
