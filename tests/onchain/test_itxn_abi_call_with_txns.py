...
_TYPED_ITXN_ABI_CALL_TXN = TEST_CASES_DIR / "typed_itxn_abi_call_txn"


def test_itxn_abi_call_with_txns(deployer: Deployer) -> None:
    caller_client = deployer.create(_TYPED_ITXN_ABI_CALL_TXN / "caller.py").client
    callee_client = deployer.create(_TYPED_ITXN_ABI_CALL_TXN / "txn_contract.py").client
