...
We provide two different types for accessing box storage: [Box](api-algopy.md#algopy.Box), and [BoxMap](api-algopy.md#algopy.BoxMap). We also expose raw operations via the [AVM ops](lg-ops.md) module.
...
To use scratch storage you need to [register the scratch storage that you want to use](lg-structure.md#contract-class-configuration) and then you can use the scratch storage [AVM ops](lg-ops.md).
