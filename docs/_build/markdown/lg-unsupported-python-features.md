...
If you do have need of such a thing, take a look at [gload_bytes](api-algopy.op.md#algopy.op.gload_bytes)
or [gload_uint64](api-algopy.op.md#algopy.op.gload_uint64) if the contracts are within the same transaction,
otherwise [AppGlobal.get_ex_bytes](api-algopy.op.md#algopy.op.AppGlobal.get_ex_bytes)
and [AppGlobal.get_ex_uint64](api-algopy.op.md#algopy.op.AppGlobal.get_ex_uint64).
...
[arc4.Struct](api-algopy.arc4.md#algopy.arc4.Struct)) don’t currently allow for inheritance. Member functions there
