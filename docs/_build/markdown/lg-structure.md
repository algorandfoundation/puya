...
[logic signatures](), and [compile-time constant code and values](lg-modules.md).
...
including reading directly from the transaction arguments via [`Txn`](api-algopy.op.md#algopy.op.Txn). This makes
