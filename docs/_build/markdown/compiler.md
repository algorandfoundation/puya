...
[Template Variables](api-algopy.md#algopy.TemplateVar), can be replaced with literal values during compilation to bytecode using the `--template-var` option.
Additionally, Algorand Python functions that create AVM bytecode, such as [compile_contract](api-algopy.md#algopy.compile_contract) and [compile_logicsig](api-algopy.md#algopy.compile_logicsig), can also provide the specified values.
...
|---------------------------------------|-------------------------------------------|----------------------------|
| [UInt64](api-algopy.md#algopy.UInt64) | `algopy.TemplateVar[UInt64]("SOME_INT")`  | `SOME_INT=1234`            |
| [Bytes](api-algopy.md#algopy.Bytes)   | `algopy.TemplateVar[Bytes]("SOME_BYTES")` | `SOME_BYTES=0x1A2B`        |
| [String](api-algopy.md#algopy.String) | `algopy.TemplateVar[String]("SOME_STR")`  | `SOME_STR="hello"`         |
