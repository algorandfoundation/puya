...
The [`compile_contract`](api-algopy.md#algopy.compile_contract) function takes an Algorand Python smart contract class and returns a [`CompiledContract`](api-algopy.md#algopy.CompiledContract),
...
This compiled contract can then be used to create an [`algopy.itxn.ApplicationCall`](api-algopy.itxn.md#algopy.itxn.ApplicationCall) transaction or used with the [ARC-4](lg-calling-apps.md) functions.

The [`compile_logicsig`](api-algopy.md#algopy.compile_logicsig) takes an Algorand Python logic signature and returns a [`CompiledLogicSig`](api-algopy.md#algopy.CompiledLogicSig), which can be used to
verify if a transaction has been signed by a particular logic signature.

## Template variables

Algorand Python supports defining [`algopy.TemplateVar`](api-algopy.md#algopy.TemplateVar) variables that can be substituted during compilation.
...
or through the `template_vars` parameter of the [`compile_contract`](api-algopy.md#algopy.compile_contract) and [`compile_logicsig`](api-algopy.md#algopy.compile_logicsig) functions.
...
The functions [`compile_contract`](api-algopy.md#algopy.compile_contract) and [`compile_logicsig`](api-algopy.md#algopy.compile_logicsig) both have an optional `template_vars` parameter
