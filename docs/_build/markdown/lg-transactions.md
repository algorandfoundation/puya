...
|-----------------------------------------------------------------------------------------|---------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [PaymentTransaction](api-algopy.gtxn.md#algopy.gtxn.PaymentTransaction)                 | [Payment](api-algopy.itxn.md#algopy.itxn.Payment)                   | [PaymentInnerTransaction](api-algopy.itxn.md#algopy.itxn.PaymentInnerTransaction)                 |
| [KeyRegistrationTransaction](api-algopy.gtxn.md#algopy.gtxn.KeyRegistrationTransaction) | [KeyRegistration](api-algopy.itxn.md#algopy.itxn.KeyRegistration)   | [KeyRegistrationInnerTransaction](api-algopy.itxn.md#algopy.itxn.KeyRegistrationInnerTransaction) |
| [AssetConfigTransaction](api-algopy.gtxn.md#algopy.gtxn.AssetConfigTransaction)         | [AssetConfig](api-algopy.itxn.md#algopy.itxn.AssetConfig)           | [AssetConfigInnerTransaction](api-algopy.itxn.md#algopy.itxn.AssetConfigInnerTransaction)         |
| [AssetTransferTransaction](api-algopy.gtxn.md#algopy.gtxn.AssetTransferTransaction)     | [AssetTransfer](api-algopy.itxn.md#algopy.itxn.AssetTransfer)       | [AssetTransferInnerTransaction](api-algopy.itxn.md#algopy.itxn.AssetTransferInnerTransaction)     |
| [AssetFreezeTransaction](api-algopy.gtxn.md#algopy.gtxn.AssetFreezeTransaction)         | [AssetFreeze](api-algopy.itxn.md#algopy.itxn.AssetFreeze)           | [AssetFreezeInnerTransaction](api-algopy.itxn.md#algopy.itxn.AssetFreezeInnerTransaction)         |
| [ApplicationCallTransaction](api-algopy.gtxn.md#algopy.gtxn.ApplicationCallTransaction) | [ApplicationCall](api-algopy.itxn.md#algopy.itxn.ApplicationCall)   | [ApplicationCallInnerTransaction](api-algopy.itxn.md#algopy.itxn.ApplicationCallInnerTransaction) |
| [Transaction](api-algopy.gtxn.md#algopy.gtxn.Transaction)                               | [InnerTransaction](api-algopy.itxn.md#algopy.itxn.InnerTransaction) | [InnerTransactionResult](api-algopy.itxn.md#algopy.itxn.InnerTransactionResult)                   |
...
[Transaction](api-algopy.gtxn.md#algopy.gtxn.Transaction) is not checked for a specific type and provides access to all transaction fields
...
`.submit()` method, or as a group by calling [`submit_txns`](api-algopy.itxn.md#algopy.itxn.submit_txns)
