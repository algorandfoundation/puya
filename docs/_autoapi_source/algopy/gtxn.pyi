# ruff: noqa: A001, E501, F403, PYI021, PYI034, W291, FBT001, PYI018
...
class PaymentTransaction(TransactionBase, _GroupTransaction):
...
class KeyRegistrationTransaction(TransactionBase, _GroupTransaction):
...
class AssetConfigTransaction(TransactionBase, _GroupTransaction):
...
class AssetTransferTransaction(TransactionBase, _GroupTransaction):
...
class AssetFreezeTransaction(TransactionBase, _GroupTransaction):
...
class ApplicationCallTransaction(TransactionBase, _GroupTransaction):
...
class Transaction(TransactionBase, _GroupTransaction):
