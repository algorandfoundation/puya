...
description: Compile-time constants, conditional compilation, and compile directives
---
...
The [`compile_contract`](/puya/api/algopy/algopy/#compile_contract) function takes an Algorand Python smart contract class and returns a [`CompiledContract`](/puya/api/algopy/algopy/#class-compiledcontract),
...
The [`compile_logicsig`](/puya/api/algopy/algopy/#compile_logicsig) takes an Algorand Python logic signature and returns a [`CompiledLogicSig`](/puya/api/algopy/algopy/#class-compiledlogicsig), which can be used to
...
or through the `template_vars` parameter of the [`compile_contract`](/puya/api/algopy/algopy/#compile_contract) and [`compile_logicsig`](/puya/api/algopy/algopy/#compile_logicsig) functions.

### CLI

The `--template-var` option can be used to [define](/puya/compiler/#defining-template-values) each variable.
...
The functions [`compile_contract`](/puya/api/algopy/algopy/#compile_contract) and [`compile_logicsig`](/puya/api/algopy/algopy/#compile_logicsig) both have an optional `template_vars` parameter
