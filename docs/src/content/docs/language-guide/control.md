---
title: Control Flow
description: If statements, loops, match statements, and ternary conditions in Algorand Python
---
...
If statements work the same as Python. The conditions must be an expression that evaluates to bool, which can include a [String or Uint64](/puya/language-guide/types/) among others.
...
Ternary conditions work the same as Python. The condition must be an expression that evaluates to bool, which can include a [String or Uint64](/puya/language-guide/types/) among others.
...
While loops work the same as Python. The condition must be an expression that evaluates to bool, which can include a [String or Uint64](/puya/language-guide/types/) among others.
...
For loops are used to iterate over sequences, ranges and [ARC-4 arrays](/puya/language-guide/arc4/). They work the same as Python.
