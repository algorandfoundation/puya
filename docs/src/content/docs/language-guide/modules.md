...
description: Module constants, type aliases, and compile-time constant code
---

You can write compile-time constant code at a module level and then use them in place of [Python built-in literal types](/puya/language-guide/types/#python-built-in-types).
