...
description: How to structure Algorand Python contracts, subroutines, and logic signatures
---
...
[logic signatures](#logic-signatures), and [compile-time constant code and values](/puya/language-guide/modules/).
...
[some inner transaction types](/puya/language-guide/transactions/#inner-transaction-objects-cannot-be-passed-to-or-returned-from-subroutines)
).
...
-   `self.counter` will be stored in the application's [Global State](/puya/language-guide/storage/#global-storage).
...
See the [ARC-4 section](/puya/language-guide/arc4/) of this language guide for more info on the above.
