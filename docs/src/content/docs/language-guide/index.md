...
description: Guide to writing Algorand smart contracts in Python
---
...
and byte arrays respectively. These are represented by [`UInt64`](/puya/api/algopy/algopy/#class-uint64) and
[`Bytes`](/puya/api/algopy/algopy/#class-bytes) in Algorand Python. There are further "bounded" types supported by the AVM
...
[`BigUInt`](/puya/api/algopy/algopy/#class-biguint) in Algorand Python.
...
[limited](/puya/language-guide/types/#python-built-in-types).

For more information on the philosophy and design of Algorand Python, please see
["Principles"](/puya/reference/principles/).
...
above, [not all features are supported](/puya/language-guide/unsupported-python-features/).