...
description: Design philosophy and guiding principles of Algorand Python
---

## Background

**Smart contracts** on the Algorand blockchain run on the Algorand Virtual Machine ([AVM](https://dev.algorand.co/concepts/smart-contracts/avm)).
This is a stack based virtual machine, which executes AVM bytecode as part of an [Application Call transaction](https://dev.algorand.co/concepts/transactions/types/#application-call-transaction).
