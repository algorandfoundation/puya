---
title: Steer users away from using reference aliases
description: Architecture decision record for changing how resource types are encoded in ABI method signatures
---
